...
public class CaldroidGridAdapter extends BaseAdapter {
    ...
    protected ArrayList<DateTime> selectedFullMoons;
    protected ArrayList<DateTime> selectedHalfMoons;
    protected ArrayList<DateTime> selectedEvents;
    ...
    protected Map<DateTime, Integer> selectedFullMoonMap = new HashMap<>();
    protected Map<DateTime, Integer> selectedHalfMoonMap = new HashMap<>();
    protected Map<DateTime, Integer> selectedEventMap = new HashMap<>();
    ...
    private void populateFromCaldroidData() {
        ...
        selectedFullMoons = (ArrayList<DateTime>) caldroidData
                .get(CaldroidFragment.SELECTED_FULL_MOON_DATES);
        if (selectedFullMoons != null) {
            selectedFullMoonMap.clear();
            for (DateTime dateTime : selectedFullMoons) {
                selectedFullMoonMap.put(dateTime, 1);
            }
        }

        selectedHalfMoons = (ArrayList<DateTime>) caldroidData
                .get(CaldroidFragment.SELECTED_HALF_MOON_DATES);
        if (selectedHalfMoons != null) {
            selectedHalfMoonMap.clear();
            for (DateTime dateTime : selectedHalfMoons) {
                selectedHalfMoonMap.put(dateTime, 1);
            }
        }

        selectedEvents = (ArrayList<DateTime>) caldroidData
                .get(CaldroidFragment.SELECTED_EVENT_DATES);
        if (selectedEvents != null) {
            selectedEventMap.clear();
            for (DateTime dateTime : selectedEvents) {
                selectedEventMap.put(dateTime, 1);
            }
        }
